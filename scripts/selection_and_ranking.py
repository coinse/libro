    ...
    for bug_id in fib_bug_ids:
        ...
        for rep, test_paths in fib_clusters[bug_id].items():
            ...
            with open(test_paths[0]) as f:
                ...
                features['test_length'] = count_test_tokens(
                    test_content.strip('```'))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', '--dataset',
                        default='Defects4J', help='Defects4J or GHRB')
    parser.add_argument('-f', '--result_file', default=None,
                        help='Path to the execution result file (e.g., `../results/example2_n50.json`)')
    parser.add_argument(
        '--gen_test_dir', default='/root/data/Defects4J/gen_tests_gpt3.5/')
    parser.add_argument('--random', action='store_true',
                        help='Produce random baseline results')
